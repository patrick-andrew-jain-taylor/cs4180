...
public class client1{
	...
	private String serverIpTest(String ipAddress){//checks for an valid server IP
	...
	private int portTest(String port) throws NumberFormatException{ //checks for a valid integer for client 1 port number
		try {
	...
	private String passwordTest(String password){
	...
	private File fileTest(String fileName, String input){
